...
$$ \frac{\partial J}{\partial net_1} = $$ %%%%%
$$ \frac{\partial J}{\partial h_1} = $$ %%%%%
$$ \frac{\partial J}{\partial net_2} = $$ %%%%
...
Thanks to the CSPAM peeps, HG, JB, JH and SCM for letting me annoy them while writing this. Preemptive apologies to JLM and JB for doing weird things.
