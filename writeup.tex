...
Parity will actually be wrong on the result because it's really $\pm \frac{z_i}{3}$. So you do need to store the sign.
...
Again, parity will actually be wrong on the result because it's really $\pm \frac{z_2z_3}{z_1}$ and so on. So you do need to store the sign.
